...
--Geezer:Print(addon_name)

function Geezer:InitializeFrame()
    local frame = CreateFrame("Frame", "GeezerFrame", UIParent, BackdropTemplateMixin and "BackdropTemplate")
    ...
    frame:SetScript("OnDragStart", function(self, button)
        frame:StartMoving()
        Geezer:Print("OnDragStart", button)
    end)
    frame:SetScript("OnDragStop", function(self)
        frame:StopMovingOrSizing()
        Geezer:Print("OnDragStop")
    end)
